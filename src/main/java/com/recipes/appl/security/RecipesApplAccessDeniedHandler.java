 ...
 */
@Component
public class RecipesApplAccessDeniedHandler implements AccessDeniedHandler {
	
	private static Logger logger = LoggerFactory.getLogger(RecipesApplAccessDeniedHandler.class);
